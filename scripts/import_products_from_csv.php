<?php
/**
 * Bulk-import products from CSV (Product Name + HSN Code).
 *
 * Usage: php scripts/import_products_from_csv.php path/to/products.csv
 */
...
if ($csvPath === null || !is_file($csvPath)) {
    fwrite(STDERR, "Usage: php scripts/import_products_from_csv.php path/to/products.csv\n");
    exit(1);
}
