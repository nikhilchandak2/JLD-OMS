    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="/dashboard" style="display: flex; align-items: center;">
                <img src="/assets/images/jld-logo.png" alt="JLD Minerals" style="height: 60px; max-height: 60px; width: auto;" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
