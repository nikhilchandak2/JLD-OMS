...
<div class="page-header">
    <div class="d-flex justify-content-between align-items-start flex-wrap gap-3">
        ...
        <div class="d-flex gap-2">
            ...
            <button class="btn btn-primary" onclick="loadDailyBusyDispatches(true)">
...
<div class="card mb-4">
    <div class="card-body">
        <div class="row g-3 align-items-end">
            ...
            <div class="col-md-3">
                <button class="btn btn-outline-primary w-100" onclick="loadDailyBusyDispatches(true)">
...
<div class="card">
    ...
    <div class="card-footer d-flex justify-content-between align-items-center">
        <button class="btn btn-sm btn-outline-secondary" id="dailyPrevBtn" onclick="changeDailyPage(-1)" disabled>Previous</button>
        <span class="small text-muted" id="dailyPageLabel">Page 1</span>
        <button class="btn btn-sm btn-outline-secondary" id="dailyNextBtn" onclick="changeDailyPage(1)" disabled>Next</button>
    </div>
</div>
...
function renderDailyTable() {
    ...
    if (!dailyRows.length) {
        tbody.innerHTML = `<tr><td colspan="9" class="text-center text-muted p-4">
            No Busy invoices for this date. Upload the day's CSV from the Dispatch Dashboard.
        </td></tr>`;
        return;
    }
